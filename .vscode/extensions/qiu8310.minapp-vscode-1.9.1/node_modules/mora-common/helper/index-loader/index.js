...
module.exports = function (content) {
    ...
    var realtimeParse = query.realtimeParse || false;
    var modules = (query.modules || []).map(function (m) { return (tslib_1.__assign({ debug: debug,
        realtimeParse: realtimeParse }, (typeof m === 'string' ? { name: m } : m))); });
    return replacer_1.replacer(this.resourcePath, content, modules).replacedContent;
};
