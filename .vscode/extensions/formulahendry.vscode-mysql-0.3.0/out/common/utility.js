...
class Utility {
    ...
    static showQueryResult(data, title) {
        vscode.commands.executeCommand("vscode.previewHtml", Utility.getPreviewUri(JSON.stringify(data)), vscode.ViewColumn.Two, title).then(() => { }, (e) => {
            outputChannel_1.OutputChannel.appendLine(e);
        });
    }
