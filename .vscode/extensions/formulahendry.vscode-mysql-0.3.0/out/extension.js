...
const sqlResultDocumentContentProvider_1 = require("./sqlResultDocumentContentProvider");
function activate(context) {
    appInsightsClient_1.AppInsightsClient.sendEvent("loadExtension");
    const provider = new sqlResultDocumentContentProvider_1.SqlResultDocumentContentProvider(context);
